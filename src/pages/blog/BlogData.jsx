...
const BlogData = () => {
  ...
  const { blog_image, blog_title, blog_text, blog_location, blog_subtext } =
    BlogContent;
  return (
      ...
      <div className="text-white w-full px-[20vw] border-2 border-solid border-black pt-10 bg-cover bg-center min-h-screen">
        <div className="blog-con-menu bg-[#272933] flex flex-col gap-14 text-white p-[20px] p768:p-[30px] mb-12">
          <div className="blogLinkContainer my-4">
            ...
            <h3 className="text-[22px] p768:text-[42px] mt-[35px] p768:mt-[120px] mb-[10px] p768:mb-[50px] leading-[120%] font-semibold">
              {blog_title}
            </h3>
            <p className="text-[18px] leading-[150%]">{blog_text}</p>
            <p className="mt-[25px]">{blog_location}</p>
            <img
              className="w-full h-[300px] p768:h-[500px] p768:object-cover object-bottom my-[20px]"
              src={blog_image}
              alt="Mahkamov | Dev"
            />
